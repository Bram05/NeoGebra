...
TextInputFieldWithDesc::TextInputFieldWithDesc(float leftX, float rightX, float topY, float bottomY, const std::string& text, float width, void(*enterCallback)(void*), void* obj, float textSize, const AdvancedString& defaultText)
