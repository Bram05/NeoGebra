...
int main()
{
	...
	equation P2lineDef{ {"l"}, "(x-l0)^2 + (y-l1)^2 = (1 / (-2*(~(l0^2+l1^2))-2*~((~(l0^2+l1^2))^2-1)) + 0.5*(~(l0^2+l1^2)) + 0.5* ~((~(l0^2+l1^2))^2-1))^2 & l0^2 + l1^2 > 1"};
	equation P2incidence{ {"p", "l"}, "(p0-l0)^2 + (p1-l1)^2 = (1 / (-2*(~(l0^2+l1^2))-2*~((~(l0^2+l1^2))^2-1)) + 0.5*(~(l0^2+l1^2)) + 0.5* ~((~(l0^2+l1^2))^2-1))^2" };
	...
	point p4 = P2m.newPoint({0.625,  0.4145780988});
